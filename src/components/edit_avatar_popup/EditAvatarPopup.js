...
function EditAvatarPopup({  
  ...
  return (
          <PopupWithForm
            ...
            >
              <>
                <input id="popup__avatarlink" name="name" placeholder="Введите ссылку на аватар"
                  className="popup__edit" type="url" value={linkAva || ''} onChange={handleChangeLink} pattern="[Hh][Tt][Tt][Pp][Ss]?://(.*)" required></input>
